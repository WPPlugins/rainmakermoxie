...
function main ()
    ...
    define ('RAINMAKER_MOXIE_PLUGIN_VERSION',                '1.1.7');
    ...
    define ('RAINMAKER_MOXIE_RAINMAKER_PERSON_URL',          'http://api.fullcontact.com/v1/person.json');
